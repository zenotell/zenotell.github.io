...
export default function SmallAll() {
  return (
        ...
        <div className="col-lg-8 col-xl-9 col-md-7 about-block">
          <div className="about-me-wrapper">
            ...
            <div className="about-me-text">
              <p>
                Привет! Я обладаю знаниями HTML, CSS, JavaScript и начал
                осванивать новый фреймворк: React. Я всегда стараюсь быть в
                курсе последних технологических тенденций и постоянно улучшаю
                свои навыки!
              </p>
            </div>
            ...
            <div className="about-table-wrapper">
              ...
              {/*  */}
              <div className="about-table-data-wrapper long-long">
                <div className="about-title">
                  <h2>Навыки</h2>
                </div>
