        ...
        <div className="col-lg-8 col-xl-9 col-md-7 about-block">
          <div className="about-me-wrapper">
            ...
            <div className="about-me-text">
              <p>
                Привет! Я обладаю неплохими знаниями HTML, CSS, JavaScript и
                начал осванивать новый фреймворк: React. Я всегда стараюсь быть
                в курсе последних технологических тенденций и постоянно улучшаю
                свои навыки. Я также неплохо умею работать с Bootstrap. Я готов
                принять любой вызов, настроен на постоянное развитие!
              </p>
            </div>
